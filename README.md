A simple C++ file encryption/decryption tool built to demonstrate and compare parallel processing techniques from an Operating Systems course standpoint.
